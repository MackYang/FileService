...
namespace SoEasy.Common
{
    public class SerializeHelper
    {
        ...
        public static string SerializeObject(object obj,OPResult opRes, bool throwException = false)
        {
        ...
        public static T Desrialize<T>(string base64Str,OPResult opRes, bool throwException = false)
        {
            return ExceptionHelper.ExceptionRecord(() =>
            {
                try
