...
namespace SoEasy.Common
{
    public class XMLHelper
    {
        ...
        /// <returns>属性值</returns>
        public static string GetXmlNodeAttribute(string filePath, string xpath, string key, OPResult opRes, bool throwException = true)
        {
        ...
        public static bool SetXmlNodeAttribute(string filePath, string xpath, string key, string value, OPResult opRes, bool throwException = true)
        {
            return ExceptionHelper.ExceptionRecord(() =>
            {
                bool flag = false;
        ...
        /// <param name="throwException">出现异常时是否抛出</param>
        /// <returns>节点值</returns>
        public static String GetXmlNodeValue(string xmlFile, string xpath, OPResult opRes, bool throwException = true)
        {
            return ExceptionHelper.ExceptionRecord(() =>
            {
        ...
        /// <param name="throwException">出现异常时是否抛出</param>
        /// <returns>true表示设置成功</returns>
        public static bool SetXmlNodeValue(string xmlFile, string xpath, string value, OPResult opRes, bool throwException = true)
        {
            return ExceptionHelper.ExceptionRecord(() =>
            {
        ...
        /// <param name="throwException">出现异常时是否抛出</param>
        /// <returns>节点值</returns>
        public static List<string> GetXmlNodeCollectValue(string xmlFile, string xpath, OPResult opRes, bool throwException = true)
        {
            return ExceptionHelper.ExceptionRecord(() =>
            {
        ...
        /// <param name="throwException">出现异常时是否抛出</param>
        /// <returns>节点值</returns>
        public static Hashtable GetHashtableFromXmlNodeCollectAttr(string xmlFile, string xpath, string keyAttrName, string valueAttrName, OPResult opRes, bool throwException = true)
        {
            return ExceptionHelper.ExceptionRecord(() =>
            {
